...
describe("Testing DemoQA", () => {
    ...
    it.skip("Elements - testing text box", () => {
        ...
        cy.get('#userName').type('Veljko Veljkovic');
        cy.get('#userEmail').type('mr.veljkovic11@gmail.com');
        cy.get('#currentAddress').type('Slavka Zlatanovica bb');
        cy.get('#permanentAffress').type('Slavka Zlatanovica 88');
    });
